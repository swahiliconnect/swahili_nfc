...
class NDEFHelper {
  ...
  dynamic convertToNDEF(BusinessCardData data, {SecurityCredentials? credentials}) {
  ...
  dynamic _createNdefMessage(Map<String, dynamic> jsonData, BusinessCardData data) {
